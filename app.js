...
function addToCart(id){const p=findProduct(id);if(!p)return;const e=cart.find(i=>i.id===id);e?e.quantity++:cart.push({id,quantity:1});persistCart();renderCart();if(cartDrawer)openCart();else alert(`${p.name} added to cart.`)}
